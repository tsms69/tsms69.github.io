...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = 'Спасибо. Ваше сообщение отправлено. Постараемся связаться с Вами в ближайшее время.';
	$response_error = 'Произошла ошибка. Попробуйте еще раз.';
